  ...
  override fun changed(projectName: String, resourcePath: String, offset: Int, removeCount: Int, newFragment: String?, replyTo: String, correlationId: String) {
    ...
    ApplicationManager.getApplication().invokeLater({
      CommandProcessor.getInstance().executeCommand(project!!, {
        ...
        highlighterService(project).sendHighlighting(document, file, resourcePath, replyTo, offset, offset + (if (newFragment.isNullOrEmpty()) 0 else newFragment!!.length()), messageConnector)
      }, "Edit", null)
    }, ModalityState.any())
  }
